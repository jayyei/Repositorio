<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <!-- v-model.lazy -->
      <!-- v-model.trim remove spaces at the beginning and the end -->
      <!-- v-model.number -->
    ...
    <div class="form-control">
      <!-- Si usas v-model en un componente personalizado, se seteara una prop especifica en el component ('modelValue') y escuchara un especifico evento ('update:modelValue') -->
      <!-- por lo tanto v-model="rating" es lo mismo que :model-value="rating" @update:modelValue="rating" -->
